...
export class SearchcountryPage {
  ...
  onCountryChange(selectElement: HTMLSelectElement) {
   ...
   // this.settingsService.ge.ipcRenderer.send('select-option', optionValue);
    ...
    console.log('selected', this.selectedCountry, this.selectedCountryName, 'detected', this.detectedCountry)  
  ...
  confirmCountry(){
    ...
    let loadingMsg = '<div class="loadContent"><ion-img src="assets/loader/loader.gif" class="loaderGif"></ion-img><p class="white">Checking country...</p></div>';
    ...
    console.log('selected', this.selectedCountry, 'detected: ', this.detectedCountry)
